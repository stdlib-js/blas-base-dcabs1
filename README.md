...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-dcabs1/tags). For example,

```javascript
dcabs1 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dcabs1@v0.0.3-umd/browser.js' )
```
